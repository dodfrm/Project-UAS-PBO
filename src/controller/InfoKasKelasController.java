 ...
 * @author Dodi
 */
public class InfoKasKelasController {
    private final InfoKasKelasView view;
    private final Database database;
    private final String nim;

    public InfoKasKelasController(InfoKasKelasView view, String nim) {
        this.view = view;
    ...
    private class TableMouseListener extends MouseAdapter{
        ...
        public void mouseClicked(MouseEvent evt) {
            ...
            try {
                byte[] imageBytes = database.getBuktiBayar(nim, bulan);
                if (imageBytes != null) {
    ...
    private class CariButtonActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent evt) {
            ...
            if (cariNama != null && !cariNama.trim().isEmpty()) {
                try {
                    List<Object[]> kasKelasData = database.searchKasKelasByName(cariNama);
                    view.updateTableData(kasKelasData);
                    view.setCariNama("");
                } catch (SQLException ex) {
                }
            } else {
    ...
    private class UpdateActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent evt) {
            ...
            if (row != -1) {
                ...
                try {
                    database.updateStatus(nim, bulan, status);
                    JOptionPane.showMessageDialog(null, "Status updated successfully!");
                    updateUangLabel(nim);
                    loadKasKelasData(nim);
                } catch (SQLException ex) {
    ...
    private class ExportButtonActionListener implements ActionListener {
        @Override
        public void actionPerformed(ActionEvent evt) {
            exportTableToExcel(view.getKasKelasTable());
        }
    }
    ...
    private class ExportCsvButtonActionListener implements ActionListener {
        @Override
        public void actionPerformed(ActionEvent evt) {
            exportTableToCSV(view.getKasKelasTable());
        }
    }
            ...
            if (userSelection == JFileChooser.APPROVE_OPTION) {
                ...
                if (saveFile != null) {
                    ...
                    try (Workbook wb = new XSSFWorkbook();
                        ...
                        Sheet sheet = wb.createSheet("dataKasKelas");
            ...
            if (row != -1) {
                ...
                try {
                    ...
                    if (option == JOptionPane.YES_OPTION) {
                        database.deleteKasKelas(nim, bulan);
    ...
    private void updateUangLabel(String nim) {
        try {
            int countStatusOne = database.countConfirmedPayments(nim);
            int totalUang = countStatusOne * 5000;
    ...
    public void loadKasKelasData(String nim) {
        try {
            List<Object[]> data = database.getKasData(nim);
